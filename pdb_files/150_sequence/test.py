...
BASE_PROMPT = (
    ...
    "Output Constraint: Return ONLY the raw Python code enclosed in a ```python block. Do not include any markdown explanations."
)
...
def extract_clean_code(raw_output):
    ...
    if clean.lower().startswith("```python"): clean = clean[9:]
